...
// Tue Mar 19 16:59:56 2024 by ROOT version 6.14/09
// from TTree ttree/ttree
// found on file: /opt/sbg/cms/ui3_data1/ccollard/HSCP_prod/prodJan2024_CMSSW_10_6_30/nt_mc_aod_eta2p1_eta3_wPU_ext1_v2.root
//////////////////////////////////////////////////////////

#ifndef TestNewCorr_h
#define TestNewCorr_h
...
#ifdef TestNewCorr_cxx
TestNewCorr::TestNewCorr(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/opt/sbg/cms/ui3_data1/ccollard/HSCP_prod/prodJan2024_CMSSW_10_6_30/nt_mc_aod_eta2p1_eta3_wPU_ext1_v2.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/opt/sbg/cms/ui3_data1/ccollard/HSCP_prod/prodJan2024_CMSSW_10_6_30/nt_mc_aod_eta2p1_eta3_wPU_ext1_v2.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/opt/sbg/cms/ui3_data1/ccollard/HSCP_prod/prodJan2024_CMSSW_10_6_30/nt_mc_aod_eta2p1_eta3_wPU_ext1_v2.root:/stage");
...
TestNewCorr::~TestNewCorr()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TestNewCorr::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TestNewCorr::LoadTree(Long64_t entry)
{
...
void TestNewCorr::Init(TTree *tree)
{
...
void TestNewCorr::Show(Long64_t entry)
{
...
Int_t TestNewCorr::Cut(Long64_t entry)
{
